...
public class C03_Exeocitions {
    public static void main(String[] args) {
        ...
        while (kontrol != 1) {
            ...
            System.out.println("Bolmek ıstedıgınız sayıyı gırınız");
            int sayı1 = scanner.nextInt();


            System.out.println("Kaca bolmek ıstedıgınızım yazınız");
            int sayı2 = scanner.nextInt();
            System.out.println("sonuc:"+ sayı1/sayı2);
            System.out.println("devam etmek ıcın 1\nbıtırmek ıcın 2 basınız");
